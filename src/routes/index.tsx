      ...
      <section id="top" className="relative min-h-screen w-full overflow-hidden">
        ...
        <div className="relative z-10 mx-auto flex min-h-screen max-w-[1400px] flex-col justify-end px-6 pb-10 pt-40 md:px-10 md:pb-14">
          ...
          <div className="mt-8">
            <a
              href="#about"
              className="inline-flex items-center border-[1.5px] border-white/30 bg-transparent px-6 py-3 text-base text-white/80 transition-colors hover:border-white/60 hover:text-white md:text-lg"
            >
              About us
            </a>
          </div>
